...
Im theoretischen Kapitel~2 werden die Grundlagen der
Geostatistik bereitgestellt und  
Semivarianz und Variogramm als zentrale Werkzeuge der räumlichen Modellierung eingeführt. Es folgt eine Übersicht gängiger Kovarianz-Modelle 
sowie der Fachbegriffe Nugget, Sill und Range. Anschließend werden die
Kriging-Gleichungen hergeleitet, die sich als Hierarchie zunehmend 
allgemeinerer Annahmen an den Erwartungswert verstehen lassen. 
Das Kapitel schließt mit einer Darstellung der geometrischen und 
zonalen Anisotropie.\\

Das darauf folgende Kapitel~3 beschreibt zunächst Herkunft und 
Struktur der verwendeten Daten: kostengünstige Sensoren, deren Daten
innerhalb des Bürger-Netzwerks \textsc{SensorCommunity} bereitgestellt werden. Nach einer mehrstufigen Datenbereinigung stehen für drei 
Monate bereinigte, monatlich gemittelte Messreihen von
rund 80--95 Sensoren zur Verfügung. \\
...
belastbarer Beweis gelingt aufgrund der begrenzten räumlichen Abdeckung jedoch nicht. \\
